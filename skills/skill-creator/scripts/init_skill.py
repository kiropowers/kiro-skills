...
Asset files are NOT loaded into context, but used within the output Kiro produces.
"""
...
def init_skill(skill_name, path, resources, include_examples):
    ...
    if resources:
        if include_examples:
            ...
            print("2. Add resources to the created directories as needed")
...
def main():
    ...
    parser.add_argument("--path", default="~/.kiro/skills", help="Output directory (default: ~/.kiro/skills)")
    ...
    if len(skill_name) > MAX_SKILL_NAME_LENGTH:
        print(f"[ERROR] Skill name '{skill_name}' is too long ({len(skill_name)} chars). Max is {MAX_SKILL_NAME_LENGTH}.")
        sys.exit(1)
